...
function UpcomingScheduleCard() {
  const priorityAnnouncements = upcomingSchedule.filter(
    (announcement) => announcement.tag === "Priority"
  );
  const otherAnnouncements = upcomingSchedule.filter(
    (announcement) => announcement.tag === "Other"
  );

...
function RecentActivityCard() {
    return (
        <article className={styles.recentActivityCard}>
            ...
            <section>
                <p className={styles.recentActivityDate}><small>10.40 AM, Fri 10 Sept 2021</small></p>
                <p className={styles.recentActivityTitle}>You Posted a New Job</p>
                <p className={styles.recentActivityDetail}>Kindly check the requirements and terms of work and make sure everything is right.</p>
            </section>
            <footer>
